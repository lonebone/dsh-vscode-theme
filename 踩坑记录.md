...
- **解决**：
  ```sh
  git config --global --add safe.directory "D:/@VUE/DeepSeekHarness_vscode/dsh-vscode-shell"
  ```
...
```sh
# 发新版（3 步）
cd D:\@VUE\DeepSeekHarness_vscode\dsh-vscode-shell
...
# 查看 npm 包
npm view dsh-vscode-shell

# 查看 GitHub Actions 状态
# https://github.com/lonebone/dsh-vscode-shell/actions
```
